...
namespace DocumentControl.DocumentRequest.KaizenReport
{
    public partial class ShowPDF : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["KaizenDocID"]))
            {
                string KaizenDocID = Request.QueryString["KaizenDocID"];
                sql = "SELECT FilePath FROM DC_KaizenDoc WHERE KaizenDocID = " + KaizenDocID + " AND Status = 1";
