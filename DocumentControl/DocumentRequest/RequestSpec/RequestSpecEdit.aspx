<%@ Page Title="แก้ไขแบบแจ้งการดำเนินการเอกสารวิศวกรรม | Document Control" Language="C#" MasterPageFile="~/DocumentRequest/Navbar.Master" AutoEventWireup="true" CodeBehind="RequestSpecEdit.aspx.cs" Inherits="DocumentControl.DocumentRequest.RequestSpec.RequestSpecEdit" MaintainScrollPositionOnPostback="true" %>
            ...
            <div class="py-2 px-3">
                ...
                <div class="row gy-1 mb-3">
                    ...
                    <div class="col-lg-6 col-12 border-start">
                        <asp:DropDownList ID="DDListProject" runat="server" DataSourceID="SqlDataSourceProject" DataValueField="ProjectID" DataTextField="ProjectName" CssClass="form-select form-select-sm" AutoPostBack="true" OnDataBound="DDListProject_DataBound"></asp:DropDownList>
                    </div>
                </div>
                <div class="row gy-1 mb-3">
                    <div class="col-lg-4 col-12">
                    ...
                    <div class="col-lg-6 col-12 border-start">
                        <asp:DropDownList ID="DDListPart" runat="server" DataSourceID="SqlDataSourcePart" DataValueField="PartID" DataTextField="PartName" CssClass="form-select form-select-sm" AutoPostBack="true" OnDataBound="DDListPart_DataBound"></asp:DropDownList>
                    </div>
                </div>
                <div class="row gy-1 mb-3">
                    <div class="col-lg-4 col-12">
                    ...
                    <div class="col-lg-6 col-12 border-start">
                        <asp:DropDownList ID="DDListFG" runat="server" DataSourceID="SqlDataSourceFG" DataValueField="FGID" DataTextField="FGName" CssClass="form-select form-select-sm" AutoPostBack="true" OnDataBound="DDListFG_DataBound"></asp:DropDownList>
                    ...
                    <div class="col-lg-8 col-12 border-start">
                        ...
                        <div class="row mt-1">
                            <div class="col-lg-6 col-12">
                                ...
                                <asp:LinkButton ID="LinkBtnOpenFile" runat="server" Text="เปิดไฟล์" CssClass="link-primary" OnClick="LinkBtnOpenFile_Click" CausesValidation="false" Visible="false"></asp:LinkButton>
                ...
                <div class="d-flex justify-content-between">
                    <asp:LinkButton ID="LinkBtnBack" runat="server" CssClass="btn btn-outline-secondary" Text="ย้อนกลับ" Width="100" OnClick="LinkBtnBack_Click"></asp:LinkButton>
                    <asp:Button ID="BtnUpdate" runat="server" Text="บันทึก" CssClass="btn btn-success" OnClick="BtnUpdate_Click" Width="100" ValidationGroup="SaveForm" />
                </div>
            </div>
        </div>
    </div>
