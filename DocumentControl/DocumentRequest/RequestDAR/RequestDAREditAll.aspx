<%@ Page Title="แก้ไขใบร้องขอ | Document Control" Language="C#" MasterPageFile="~/DocumentRequest/Navbar.Master" AutoEventWireup="true" CodeBehind="RequestDAREditAll.aspx.cs" Inherits="DocumentControl.DocumentRequest.RequestDAR.RequestDAREditAll" Culture="en-US" %>
    ...
    <div class="container pt-3 pb-2">
        <div class="border p-3 bg-white">
            ...
            <div class="py-2 px-3">
                ...
                <div>
                    <asp:GridView ID="GVRequestDARDoc" runat="server" CssClass="table table-borderless border-0 mb-0" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText='วันที่บังคับใช้<span class="text-danger">*</span>'>
                                <ItemTemplate>
                                    <asp:TextBox ID="TxtDocDate" runat="server" CssClass="form-control form-control-sm datepicker" Text='<%# DateTime.Parse(Eval("DateEnforce").ToString()).ToString("dd/MM/yyyy") %>' placeholder="dd/MM/yyyy"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="เอกสารแนบ">
                                <ItemTemplate>
                                    <div class="d-flex">
                                        ...
                                        <asp:ImageButton ID="ImageBtnDownload" CssClass="shadow-hover" runat="server" CommandName="BtnDownload" CommandArgument='<%# Eval("FilePath") %>' Height="30" ImageUrl="~/Image/download.png" />
                                    </div>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
            ...
            <div class="py-2 px-3">
                ...
                <div class="row gy-1 mb-3">
                    ...
                    <div class="col-md-8 col-lg-9 col-12 border-start">
                        <asp:TextBox ID="TxtAcceptLeader" runat="server" CssClass="form-control form-control-sm" Style="width: 300px;" Enabled="false" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
                ...
                <div class="row gy-1 mb-2">
                    ...
                    <div class="col-md-8 col-lg-9 col-12 border-start">
                        <asp:TextBox ID="TxtApprove" runat="server" CssClass="form-control form-control-sm" Style="width: 300px;" Enabled="false" ReadOnly="true"></asp:TextBox>
                    </div>
                </div>
            </div>
            <div class="text-center d-flex justify-content-between">
                <asp:HyperLink ID="HLBack" runat="server" CssClass="btn btn-outline-secondary" Text="กลับ" NavigateUrl="~/DocumentRequest/RequestDAR/RequestDARAll.aspx" Width="100"></asp:HyperLink>
